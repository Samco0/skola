...
#ifndef STRING_OPAKOVANI_PRIVATE_H
#define STRING_OPAKOVANI_PRIVATE_H
...
#define ORIGINAL_FILENAME	"string opakovani.exe"
#define PRODUCT_NAME	"string opakovani"
#define PRODUCT_VERSION	"0.1.1.1"

#endif /*STRING_OPAKOVANI_PRIVATE_H*/
